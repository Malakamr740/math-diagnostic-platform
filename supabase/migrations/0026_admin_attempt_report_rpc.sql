-- ============================================================
-- Migration 0026: Admin/Teacher Detailed Attempt Diagnostic Report
-- ============================================================

create or replace function get_admin_attempt_report(
  p_attempt_id uuid
)
returns jsonb
language plpgsql
...
begin
  -- Verify caller is an authenticated staff member for this organization
  ...
  if v_org_id <> v_user_org_id then
    raise exception 'Access denied for this organization.';
  end if;
